...
namespace Rope {
    ...
    // Interleaved multi-axis RoPE used by Ideogram 4. Mirrors the reference
    // stack(...).permute(...) mrope construction: build per-axis rotary
    // embeddings, then interleave the frequency bands per mrope_section.
