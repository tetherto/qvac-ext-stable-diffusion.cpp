...
int main(int argc, char** argv) {
    ...
    ModelLoader& ml = model_manager->loader();
    ...
    ABOT::AbotWorldRunner runner(be, pbe, ml.get_tensor_storage_map(), "model.diffusion_model", cfg, model_manager);
    ...
    printf("DiT loaded with August model manager\n");
